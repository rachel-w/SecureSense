				...
				<p>
					...
					<div class="row">
							...
							<div class="panel panel-info">
								<div class="panel-body">
									...
									<form action="crtinstbl.php" method="post">
										...
										<input class="btn btn-warning" type="reset" value="CLEAR FIELDS" > 
									</form>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-5">
							<div class="panel panel-info">
								<div class="panel-body">
								<h5 class="text-uppercase">Quick Tips:</h5>
									<div class="list-group text-capitalize">
  										<li href="#" class="list-group-item ">Make sure the users is aware of this creation!</li>
  										<li href="#" class="list-group-item ">Sent the user a email to let him/her about the account</li>
  										<li href="#" class="list-group-item ">Make sure you let the users reset his/her pasword</li>
  										<li href="#" class="list-group-item ">The password will not be hashed, it is recommed for the user to register</li>
									</div>
								</div>
							</div>
						</div>
